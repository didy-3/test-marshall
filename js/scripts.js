...
/* harmony export */   "getCatalog": function() { return /* binding */ getCatalog; }
/* harmony export */ });
...
function fetchMock() {
  return Promise.resolve({
    catalog: {
      filters: ["multi-room", "Amazon alexa", "Google assistant", "spotify connect", "Chromecast Built-in", "Wi-Fi", "Bluetooth", "Airplay", "3.5 mm Input", "RCA Input", "Portable (Battery)"],
      speakers: [{
...
/* harmony default export */ __webpack_exports__["default"] = (arrowScroll);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _apiCaller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apiCaller */ "./src/js/apiCaller.js");
...
const catalog = () => {
  ...
  if (catalogElem === null || filterItems === null) return;
  ...
  function restyleAll() {
    chosenFiltersByUser = Object.entries(catalog.filters).filter(_ref => {
      let [key, value] = _ref;
      return value;
    }).map(it => it[0]);
    ...
    for (let i = 0; i < catalogItemElems.length; i++) {
      if (!elementsToBeShown.includes(catalogItemElems[i].id)) {
        ...
        shownItemsCounter++;
        catalogItemElems[i].classList.remove('hidden-element-in-mobile-version');
        if (shownItemsCounter > 4) catalogItemElems[i].classList.add('hidden-element-in-mobile-version');
      }
    }
  ...
  function renderButton() {
    ...
    if (shownElements < 5) return;
    if (moreBtnIsShown) return;
  ...
  function createShowMoreBtn() {
    ...
    showMoreBtn.addEventListener('click', () => {
      ...
      for (let item of catalogItemElems) item.classList.remove('hidden-element-in-mobile-version');
  ...
  (async function getData() {
    let catalogData = await (0,_apiCaller__WEBPACK_IMPORTED_MODULE_0__.getCatalog)();
...
const playVideo = () => {
  ...
  playBtns.forEach(btn => {
    btn.addEventListener('click', () => {
      let videoElem = btn.parentNode.querySelector('.slider-img');
      videoElem.innerHTML = `<iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
  ...
  cartItems.forEach(it => {
    ...
    minus.addEventListener('click', () => {
      ...
      if (num === 0) {
        ...
        if (num >= 10) input.value = num;
      }

      countTotalPrice();
    });
    plus.addEventListener('click', () => {
      if (num === 0) minus.disabled = false;
      num++;
      if (num < 10) input.value = `0${num}`;
      if (num >= 10) input.value = num;
      countTotalPrice();
...
const slider = () => {
  ...
  const bgSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.bg-swiper', {
    slidesPerView: 1,
    spaceBetween: 0,
    loop: true
  });
...
/* harmony import */ var _burgerNav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./burgerNav */ "./src/js/burgerNav.js");
/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./catalog */ "./src/js/catalog.js");
/* harmony import */ var _arrowScroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./arrowScroll */ "./src/js/arrowScroll.js");
/* harmony import */ var _playVideo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./playVideo */ "./src/js/playVideo.js");
/* harmony import */ var _shoppingCart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shoppingCart */ "./src/js/shoppingCart.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_burgerNav__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_catalog__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_arrowScroll__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_playVideo__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_shoppingCart__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
}();
/******/ })()
;
